...
public:
	...
	void record(VkCommandBuffer& commandBuffer, VkStridedDeviceAddressRegionKHR& raygen, VkStridedDeviceAddressRegionKHR& miss, VkStridedDeviceAddressRegionKHR& hit, uint32_t imageIndex, uint32_t width, uint32_t height, bool additionalRTFlag);
