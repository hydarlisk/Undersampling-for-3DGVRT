...
struct VulkanDevice
{
	...
	VkResult        createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, vks::Buffer *buffer, VkDeviceSize size, void *data = nullptr, std::string name = "");
	...
	VkResult createAndCopyToDeviceBuffer(void* data, VkBuffer* buffer, VkDeviceMemory* memory, size_t bufferSize, VkQueue queue, VkBufferUsageFlags usageFlags = 0x0, VkMemoryPropertyFlags memoryFlags = 0x0);
	VkResult createAndCopyToDeviceBuffer(void* data, vks::Buffer& buffer, size_t bufferSize, VkQueue& queue, VkBufferUsageFlags usageFlags = 0x0, VkMemoryPropertyFlags memoryFlags = 0x0);
